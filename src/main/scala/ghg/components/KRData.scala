    ...
    def render(P: Props) = {
      ...
      <.div(
        ...
        MuiTabs()(
          ...
          MuiTab(label = "Quá trình khử Nitơ", style = tabLabel)(
          ...
          MuiTab(label = "Phân hủy yếm khí", style = tabLabel)(
            table(
          ...
          MuiTab(label = "Quá trình đốt", style = tabLabel)(
            table(
