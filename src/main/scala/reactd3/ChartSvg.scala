...
//FIXME y
case class ChartSvg[T <: js.Object](data: js.Array[T],
  ...
  def apply(otherProps: js.Object) = {
    val props = es6.Object.assign(js.Dynamic.literal(), otherProps, JSMacro[ChartSvg[_]](this))
    val f = React.asInstanceOf[js.Dynamic].createFactory(ReactD3.Svg)
